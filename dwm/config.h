...
static const int showsystray        = 1;     /* 0 means no systray */     /* snap pixel */
...
static const char col_gray3[]       = "#25272f"; // 96b5b4
static const char col_gray4[]       = "#7d818b"; // d7d7d7
static const char col_cyan[]        = "#6094dc"; // 5294e2
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray1, col_gray2, col_gray3 },
	[SchemeSel]  = { col_cyan,  col_gray3, col_gray2 },
};

/* tagging */
//                           Term Chrome Dev Desk DB   File Sett      Firefox
...
static const char *dmenucmd[]    = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray2, "-nf", col_gray1, "-sb", col_gray3, "-sf", col_cyan, NULL };
